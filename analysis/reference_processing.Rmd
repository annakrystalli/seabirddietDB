...
- drag down error in `Daunt & Wanless IMLOT 1973-2014`
...
- Correct excel drag down error in references: `Daunt & Wanless IMLOT 1973-2015:2127`.
...
```{r}
stringr::str_count(ref_manual$rename, ";") %>% max() + 1
```
